        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <nav class="navbar navbar-expand bg-white shadow mb-4 topbar static-top navbar-light">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Add Unit</h3>
                    <div class="card shadow" style="margin-top: 20px;">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">Add Unit</p>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" type="text" id="unit_number" name="unit_number" placeholder="Unit Number" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" type="number" id="block_number" placeholder="Block Number" name="block_number" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" type="number" id="floor" placeholder="Floor" name="floor" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <input class="btn btn-primary btn-sm" type="submit" value="Add Unit">
                                </div>
                            </form>
                        </div>
                    </div>
