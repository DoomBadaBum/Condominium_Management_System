...
$sqlBookings = "SELECT b.booking_id, u.fullname, f.facility_name, b.booking_date, b.start_time, b.end_time
FROM booking b
...
$sqlTotal = "SELECT COUNT(booking_id) AS total FROM booking";
...
<head>
    ...
    <title>Staff - View Booking Facility</title>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">View Booking Facility</h3>
                    <div class="card shadow" style="margin-top: 20px;">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">View Booking Facility</p>
                        </div>
                        <div class="card-body">
                            ...
                            <?php if ($resultBookings->num_rows > 0): ?>
                                <table class="table my-0" id="dataTable">
                                    <thead>
                                        <tr>
                                            <th style="padding: 7px 184px 8px 8px;padding-right: 0px;width: 151.922px;">Name</th>
                                            <th style="padding: 7px 184px 8px 8px;padding-right: 0px;width: 151.922px;">Facility</th>
                                            <th style="padding: 7px 184px 8px 8px;padding-right: 0px;width: 151.922px;">Booking Date</th>
                                            <th style="padding: 7px 184px 8px 8px;padding-right: 0px;width: 151.922px;">Start Time</th>
                                            <th style="width: 129.156px;">End Time</th>
                                    ...
                                    <?php while ($row = $resultBookings->fetch_assoc()): ?>
                                        <tr>
                                            <td style="height: 42px;"><?php echo $row['fullname']; ?></td>
                                            <td style="height: 42px;"><?php echo $row['facility_name']; ?></td>
                                            <td style="height: 42px;"><?php echo $row['booking_date']; ?></td>
                                            <td style="height: 42px;"><?php echo $row['start_time']; ?></td>
                                            <td style="height: 42px;"><?php echo $row['end_time']; ?></td>
                                            <td>
                                                <a class="btn btn-warning" href="update_booking.php?booking_id=<?php echo $row['booking_id']; ?>" style="margin-right: 10px;">Update</a>
                                                <a class="btn btn-danger" href="delete_booking_facility.php?booking_id=<?php echo $row['booking_id']; ?>" onclick="return confirm('Are you sure you want to delete this booking facility? (Yes/No)')">Delete</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                    <tfoot>
                            ...
                            <div class="row">
                                <div class="col-md-6 align-self-center">
                                    <p id="dataTable_info" class="dataTables_info" role="status" aria-live="polite">
                                        ...
                                        to <?php echo min($currentPage * $recordsPerPage, $rowTotal["total"]); ?> of <?php echo $rowTotal["total"]; ?> entries
                                    </p>
                                </div>
                                <?php if ($totalPages > 1): ?>
                                <div class="col-md-6">
                                    <nav aria-label="Page navigation" class="d-lg-flex justify-content-lg-end dataTables_paginate paging_simple_numbers">
                                        <ul class="pagination">
                                            <?php if ($currentPage > 1): ?>
                                                <li class="page-item">
                                                    <a class="page-link" href="view_booking.php?page=<?php echo $currentPage - 1; ?>" aria-label="Previous">
                                            ...
                                            <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                                                <li class="page-item <?php if ($i == $currentPage) echo 'active'; ?>">
                                                    <a class="page-link" href="view_booking.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>
                                                </li>
                                            <?php endfor; ?>

                                            <?php if ($currentPage < $totalPages): ?>
                                                <li class="page-item">
                                                    <a class="page-link" href="view_booking.php?page=<?php echo $currentPage + 1; ?>" aria-label="Next">
