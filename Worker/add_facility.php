...
<head>
    ...
    <title>Staff - Add Facility</title>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <nav class="navbar navbar-expand bg-white shadow mb-4 topbar static-top navbar-light">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Add Facility</h3>
                    <div class="card shadow" style="margin-top: 20px;">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">Add Facility</p>
                        </div>
                        <div class="card-body">
                            <form action="add_facility.php" method="post">
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3">
                                            <label class="form-label" for="facility_name"><strong>Facility Name</strong></label>
                                            <input class="form-control" type="text" id="facility_name" name="facility_name" placeholder="Facility Name" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <input class="btn btn-primary btn-sm" type="submit" value="Add Facility">
                                </div>
                            </form>
                        </div>
                    </div>
