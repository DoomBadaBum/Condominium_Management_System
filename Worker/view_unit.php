        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">View Units</h3>
                    <div class="card shadow" style="margin-top: 20px;">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">View Units</p>
                        </div>
                        <div class="card-body">
                            ...
                            <?php if ($resultUnits->num_rows > 0): ?>
                                <table class="table my-0" id="dataTable">
                                    <thead>
                                        <tr>
                                            <th style="padding: 7px 184px 8px 8px;padding-right: 0px;width: 151.922px;">Unit Number</th>
                                            <th style="padding: 7px 184px 8px 8px;padding-right: 0px;width: 151.922px;">Size m<sup>2</sup></th>
                                            <th style="padding: 7px 184px 8px 8px;padding-right: 0px;width: 151.922px;">Block Number</th>
                                            <th style="padding: 7px 184px 8px 8px;padding-right: 0px;width: 151.922px;">Floor</th>
                                    ...
                                    <?php while ($row = $resultUnits->fetch_assoc()): ?>
                                        <tr>
                                            <td style="height: 42px;"><?php echo $row['unit_number']; ?></td>
                                            <td style="height: 42px;"><?php echo $row['size']; ?></td>
                                            <td style="height: 42px;"><?php echo $row['block_number']; ?></td>
                                            <td style="height: 42px;"><?php echo $row['floor']; ?></td>
                                            <td>
                                                <a class="btn btn-warning" style="margin-right: 10px;" href="update_unit.php?unit_id=<?php echo $row['unit_id']; ?>">Update</a>
                                                <a class="btn btn-danger" style="min-width: 79px;" href="delete_unit.php?unit_id=<?php echo $row['unit_id']; ?>" onclick="return confirm('Are you sure you want to delete this unit?')">Delete</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                    <tfoot>
