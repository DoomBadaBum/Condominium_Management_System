...
<head>
    ...
    <title>Staff - Update Facility</title>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <nav class="navbar navbar-expand bg-white shadow mb-4 topbar static-top navbar-light">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Update Facility</h3>
                    <div class="card shadow" style="margin-top: 20px;">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">Update Facility</p>
                        </div>
                        <div class="card-body">
                            <form action="" method="post">
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3"><input type="hidden" name="facility_id" value="<?php echo $facility['facility_id']; ?>"></div>
                                        <div class="mb-3"><label class="form-label" for="username"><strong>Facility Name</strong></label><input class="form-control" type="text" id="facility_name" name="facility_name" value="<?php echo $facility['facility_name']; ?>" required></div>
                                    </div>
                                </div>
                                <div class="mb-3">
