...
<aside>
    <nav>
        <ul>
            <li><a href="dashboard_worker.php">Home</a></li>
            <li><a href="assign_maintenance.php">Assign Maintenance Requests</a></li>
            <li><a href="view_maintenance_requests.php">View Maintenance Requests</a></li>
