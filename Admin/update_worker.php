...
$sqlResident = "SELECT * FROM user WHERE role_id = 3 AND user_id = $userId";
...
<head>
    ...
    <title>Admin - Update Staff Details</title>
                    ...
                    <div class="col">
                        <div class="card shadow mb-3">
                            <div class="card-header py-3">
                                <p class="text-primary m-0 fw-bold">Update Staff Details</p>
                            </div>
                            <div class="card-body">
                                <form action="update_worker.php?user_id=<?php echo $userId; ?>" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col">
                                    ...
                                    <div class="mb-3">
                                        <a class="btn btn-primary btn-sm" href="view_worker.php">Back</a>
                                        <input class="btn btn-warning btn-sm" type="submit" value="Update Staff">
                                    </div>
                                </form>
                            </div>
                        </div>
